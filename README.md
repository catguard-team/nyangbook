...
> 냥북 — 라즈베리파이 기반 자경단 보급 디바이스입니다.

**한 줄 요약**: 어르신·새끼고양이분들이 인터넷·문서·코딩 첫발을 떼시는 데 필요한 최소한의 "내 컴퓨터"입니다.

**철학**: 새 부품을 사시기 전에 동네에 굴러다니는 부품부터 활용합니다. 못 구하실 때만 신품을 사용합니다. 빠른 것이 아니라 **충분한 것**을 만들어 드리려고 합니다.
...
각 시나리오별 자동 설정은 [`saenoyangi-handbook`](https://github.com/catguard-team/saenoyangi-handbook) 트랙과 연동됩니다.

---

## 기여

부품 가격 변동, 새 모델 출시, 국내 유통처 정보는 [`BOM.md`](./BOM.md) PR로 보내주시면 환영합니다. 가격은 **국내 일반 유통가 (쿠팡/네이버/디바이스마트)** 기준으로 정리합니다.
...
<div align="center">
  <sub>동네에 굴러다니는 부품부터 · <strong>고맙습니다. 냐-옹.</strong></sub>
</div>
